...
(python gfwtools.py networks vpn --prefer include --base foreign --excludes data/thunets.txt,data/cnnets.txt | python gfwtools.py generate vpnroutes --gateway "10.123.0.3 dev gre2") > /usr/local/bin/vpnroutes2.sh
